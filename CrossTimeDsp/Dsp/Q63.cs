...
namespace CrossTimeDsp.Dsp
{
    internal class Q63
    {
        ...
        public Q63(double value, int fractionalBits)
        {
            ...
            this.value = (long)(Math.Pow(2.0, (double)fractionalBits) * value);
        }
        ...
        /// caller's responsibility.
        /// </summary>
        public static long operator *(Q63 x, long y)
        {
