...
{
	Biquad1Q31_64x64::Biquad1Q31_64x64(BiquadCoefficients coefficients, __int32 channels)
	{
	...
	Biquad1Q31_64x64::~Biquad1Q31_64x64()
	{
		delete this->a1;
		delete this->a2;
		delete this->b0;
	...
	/// </summary>
	void Biquad1Q31_64x64::Filter(__int32* block, __int32 offset)
	{
	...
	void Biquad1Q31_64x64::FilterReverse(__int32* block, __int32 offset)
	{
		__int32 maxSample = offset + Constant::FilterBlockSizeInInt32s;
