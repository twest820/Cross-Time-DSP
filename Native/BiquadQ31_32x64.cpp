...
{
	BiquadQ31_32x64::BiquadQ31_32x64(double b0, double b1, double b2, double a0, double a1, double a2, __int32 channels)
	{
		a1 /= a0;
		a2 /= a0;
		b0 /= a0;
		...
		this->postShift = Q31::GetQ31_32x64_PostShift(std::initializer_list<double>({ a1, a2, b0, b1, b2 }));
	...
	BiquadQ31_32x64::~BiquadQ31_32x64()
	{
		delete this->a1;
		delete this->a2;
		delete this->b0;
	...
	/// </summary>
	void BiquadQ31_32x64::Filter(__int32* block, __int32 offset)
	{
	...
	void BiquadQ31_32x64::FilterReverse(__int32* block, __int32 offset)
	{
		__int32 maxSample = offset + Constant::FilterBlockSizeInInt32s;
		if (this->channels == 2)
		{
