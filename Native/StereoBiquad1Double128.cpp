...
{
	StereoBiquad1Double128::StereoBiquad1Double128(BiquadCoefficients coefficients)
	{
	...
	void StereoBiquad1Double128::Filter(double* block, __int32 offset)
	{
	...
	void StereoBiquad1Double128::FilterReverse(double* block, __int32 offset)
	{
