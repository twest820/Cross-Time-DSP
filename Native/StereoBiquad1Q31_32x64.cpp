...
{
	StereoBiquad1Q31_32x64::StereoBiquad1Q31_32x64(BiquadCoefficients coefficients)
	{
	...
	StereoBiquad1Q31_32x64::~StereoBiquad1Q31_32x64()
	{
		delete this->a1;
		delete this->a2;
		delete this->b0;
	...
	/// </summary>
	void StereoBiquad1Q31_32x64::Filter(__int32* block, __int32 offset)
	{
	...
	void StereoBiquad1Q31_32x64::FilterReverse(__int32* block, __int32 offset)
	{
		__int32 maxSample = offset + Constant::FilterBlockSizeInInt32s;
